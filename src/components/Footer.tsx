      ...
      <div className="footer-container">
        <div className="footer-top">
          ...
          {footerColumns.map((col, index) => (
            <div className="footer-link-col" key={index}>
              <h3 className="footer-col-heading">{col.heading}</h3>
              <div className="footer-links-list">
                {col.links.map((link, i) => (
                  <span className="footer-link-item" key={i}>{link}</span>
                ))}
              </div>
            </div>
          ))}
        ...
        <div className="footer-bottom">
          <span className="footer-copyright">© 2026 NEXUS. All rights reserved.</span>
          <div className="footer-bottom-right">
            <span className="footer-country-text">Country: United States | Language: English</span>
            <div className="footer-payment-row">
              {paymentBadges.map((badge, index) => (
                <span className="footer-payment-badge" key={index}>{badge}</span>
              ))}
            </div>
          </div>
        </div>
